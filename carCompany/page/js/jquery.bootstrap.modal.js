        ...
        var modalHtml = ''
            +'<div class="modal wModal '+fade+' " id="'+wModal_id+'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'
                +'<div class="modal-dialog" style="margin:15% auto">'
                    +'<div class="modal-content" style="width:329px;margin-left: 19%">'
                        +'<div class="modal-header" style="background-color: #ff6600; border-radius: 4px;padding:8px;">'
                            +'<button type="button" class="close wCancle"  style="font-size:32px;opacity: 1;text-shadow: 0 1px 0 #000"><span aria-hidden="true">&times;</span><span class="sr-only">关闭</span></button>'
                            +'<h4 class="modal-title" id="wModalLabel" style="color: #fff;">'+title+'</h4>'
                        +'</div>'
                        +'<div class="modal-body">'
                            +content
                        +'</div>'
                        +'<div class="modal-footer">'
                            +'<button type="button" class="btn btn-warning  wSure" style=" background-color: #ff6600;">确定</button>'
                            +'<button type="button" class="btn btn-default wCancle" >取消</button>'
                        +'</div>'
                    +'</div>'
                +'</div>'
            +'</div>';
